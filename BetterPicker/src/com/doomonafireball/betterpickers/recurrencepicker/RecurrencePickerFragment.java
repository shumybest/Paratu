...
public class RecurrencePickerFragment extends Fragment implements OnItemSelectedListener,
    ...
    // in dp's
    protected static final int MIN_SCREEN_WIDTH_FOR_SINGLE_ROW_WEEK = 450;

    // Update android:maxLength in EditText as needed
    protected static final int INTERVAL_MAX = 99;
    protected static final int INTERVAL_DEFAULT = 1;
    // Update android:maxLength in EditText as needed
    protected static final int COUNT_MAX = 730;
    protected static final int COUNT_DEFAULT = 5;
    ...
    protected CalendarDatePickerDialog mDatePickerDialog;

    protected class RecurrenceModel implements Parcelable {
    ...
    protected EventRecurrence mRecurrence = new EventRecurrence();
    protected Time mTime = new Time(); // TODO timezone?
    protected RecurrenceModel mModel = new RecurrenceModel();
    protected Toast mToast;

    protected final int[] TIME_DAY_TO_CALENDAR_DAY = new int[]{
            Calendar.SUNDAY,
            Calendar.MONDAY,
            Calendar.TUESDAY,
            Calendar.WEDNESDAY,
    ...
    protected static final int[] mFreqModelToEventRecurrence = {
    ...
    protected static final String BUNDLE_MODEL = "bundle_model";
    protected static final String BUNDLE_END_COUNT_HAS_FOCUS = "bundle_end_count_has_focus";

    protected static final String FRAG_TAG_DATE_PICKER = "tag_date_picker_frag";
    ...
    protected int mIntervalResId = -1;
    ...
    protected ArrayList<CharSequence> mEndSpinnerArray = new ArrayList<CharSequence>(3);
    protected EndSpinnerAdapter mEndSpinnerAdapter;
    protected String mEndNeverStr;
    protected String mEndDateLabel;
    protected String mEndCountLabel;
    ...
    // Sun = 0
    protected ToggleButton[] mWeekByDayButtons = new ToggleButton[7];
    /**
     ...
     */
    protected String[][] mMonthRepeatByDayOfWeekStrs;

    protected LinearLayout mMonthGroup;
    ...
    protected String mMonthRepeatByDayOfWeekStr;
    ...
    static protected void copyEventRecurrenceToModel(final EventRecurrence er,
    ...
    static protected void copyModelToEventRecurrence(final RecurrenceModel model,
            EventRecurrence er) {
    ...
    protected void togglePickerOptions() {
    ...
    protected void updateIntervalText() {
        if (mIntervalResId == -1) {
            return;
        }
     ...
     * entered for N.
     */
    protected void updateEndCountText() {
    ...
    protected class EndSpinnerAdapter extends ArrayAdapter<CharSequence> {
