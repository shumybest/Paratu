...
public class DatePicker extends LinearLayout implements Button.OnClickListener,
    ...
    protected View.OnClickListener mDateRightListener;
    ...
    private class KeyboardPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            if (mDateFormatOrder[position] == DateFormat.MONTH) {
                ...
                mDateRight.setBackgroundResource(mKeyBackgroundResId);
                if(mDateRightListener != null) {                	
                	mDateRight.setOnClickListener(mDateRightListener);
                }
    ...
    public void setDateRightListener(View.OnClickListener listener) {
    	mDateRightListener = listener;
    }
    ...
    public void setDate(int year, int monthOfYear, int dayOfMonth) {
        ...
        for (int i = 0; i < mDateFormatOrder.length; i++) {
        	mKeyboardPager.setCurrentItem(mDateFormatOrder.length - 1, true);
