...
import com.iot.wizard.model.MultipleFixedChoicePage;
import com.iot.wizard.model.Page;
...
public class MultipleChoiceFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                ArrayList<String> selectedItems = mPage.getReviewData().getStringArrayList(
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        mPage.getReviewData().putStringArrayList(Page.SIMPLE_DATA_KEY, selections);
