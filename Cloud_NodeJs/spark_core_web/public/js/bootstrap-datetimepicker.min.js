!function (c) {
    ...
    var e = function (h, g) {
        ...
        this.component = this.element.is(".date") ? (this.bootcssVer == 3 ? this.element.find(".glyphicon-calendar,.input-group-addon .glyphicon-th, .input-group-addon .glyphicon-time, .input-group-addon .glyphicon-calendar").parent() : this.element.find(".add-on .icon-th, .glyphicon-calendar, .glyphicon-th,.add-on .icon-time, .add-on .icon-calendar").parent()) : false;
